...
public class SearchProvider {
    ...
    public static List<VoidEntry> search(Collection<VoidEntry> items, SearchQuery query) {
        List<VoidEntry> result = new ArrayList<>();
        itemLoop: for (VoidEntry entry : items) {
            // ID check
            if (NbtVoid.getConfig().getIdCheck() == Config.CheckType.ANY) {
            ...
            // Name check
            if (NbtVoid.getConfig().getNameCheck() == Config.CheckType.ANY) {
            ...
            // NBT check
            if (NbtVoid.getConfig().getNbtCheck() == Config.CheckType.ANY) {
